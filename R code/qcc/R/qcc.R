...
library(utils)
assignInNamespace("limits.np", limits.np, ns="qcc")
summary(qcc(JANDEFECT, 
              type="p", 
              sizes=100, confidence.level=0.95))

pbar = 0.05387096774193548
qbinom((1 - 0.9)/2, 100, pbar, lower.tail = FALSE)
